...
COMSCORE.SiteRecruit.Builder.config = {
	...
	invitation: [
					...
					secureUrl: '',
					acceptParams: {
						raw: 'l=2058&H_SurveyType=1',
						siteCode: (_site)?_site:'2252',
												cookie: [
													],
												otherVariables: [
													]
