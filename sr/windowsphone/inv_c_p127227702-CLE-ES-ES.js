...
COMSCORE.SiteRecruit.Builder.config = {
	...
	invitation: [
					...
					secureUrl: '',
					acceptParams: {
						raw: 'l=10&H_SurveyType=1',
						siteCode: (_site)?_site:'2251',
												cookie: [
													],
												otherVariables: [
													]
